      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="max-w-lg mx-auto">
            <form className="flex items-center gap-2 p-1.5 rounded-xl bg-[rgba(255,255,255,0.04)] backdrop-blur border border-white/10 shadow-[0_0_60px_rgba(13,148,136,0.15)]">
              ...
              <button
                type="submit"
                className="px-6 py-3 bg-gradient-to-r from-[#0d9488] to-[#0dc8aa] hover:from-[#0f766e] hover:to-[#0d9488] rounded-lg text-white text-sm font-semibold transition-all shrink-0"
              >
                Audit Now
              </button>
            </form>
